                ...
                <div class="card bg-light">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <button type="submit" name="guardar" class="btn btn-primary me-2">
                                    <i class="fas fa-save me-1"></i> <?php echo $form_submit; ?>
                                </button>
                                <a href="productos.php" class="btn btn-outline-secondary me-2">
                                    <i class="fas fa-times me-1"></i> Cancelar
                                </a>
                            </div>
                            <?php if (isset($producto['id']) && !empty($producto['id'])): ?>
                            <div>
                                <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#eliminarProductoModal">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="eliminar-producto.php?id=<?php echo $producto['id']; ?>" class="btn btn-danger">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="mb-3">
                    ...
                    <div class="form-text">Código único de inventario</div>
                </div>
            </div>
        </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <input type="number" class="form-control" id="garantia" name="garantia" 
                               min="0" value="<?php echo htmlspecialchars($producto['garantia'] ?? ''); ?>">
            ...
            <div class="col-md-3">
                <div class="mb-3">
                    ...
                    <div class="form-check form-switch mb-2">
                        <input class="form-check-input" type="checkbox" id="envio_gratis" name="envio_gratis" value="1"
                            <?php echo !empty($producto['envio_gratis']) ? 'checked' : ''; ?>>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <input type="number" class="form-control" id="largo" name="largo" 
                               step="0.1" min="0" 
                               value="<?php echo htmlspecialchars($producto['largo'] ?? ''); ?>">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <input type="number" class="form-control" id="ancho" name="ancho" 
                               step="0.1" min="0" 
                               value="<?php echo htmlspecialchars($producto['ancho'] ?? ''); ?>">
                        <span class="input-group-text">cm</span>
                    </div>
                </div>
            </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <input type="number" class="form-control" id="alto" name="alto" 
                               step="0.1" min="0" 
                               value="<?php echo htmlspecialchars($producto['alto'] ?? ''); ?>">
                        <span class="input-group-text">cm</span>
                    </div>
                </div>
            </div>
